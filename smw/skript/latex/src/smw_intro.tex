...
\begin{frame}[t]{Modellierung eines Informationsbedürfnisses}
	Überführen Sie den nachfolgend dargestellen Sachverhalt in ein minimales \redalert{Datenmodell} einer Sprache Ihrer Wahl\footnote{Für diese Aufgabe ist es i.O., wenn Sie sich auf die wesentlichen Aspekte konzentrieren und diese im Datenmodell darstellen.}: \bigskip
...
\begin{frame}{Datenstrukturelement: Seite}
	...
	Mit Ausnahme von Datentypen und Subobjects werden alle Sprachelemente im Rahmen einer Seite definiert.
