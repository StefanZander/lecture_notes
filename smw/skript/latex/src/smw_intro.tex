...
\begin{frame}[t]{Modellierung eines Informationsbedürfnisses / eines realen Gegenstandbereichs}
	Überführen Sie den nachfolgend dargestellten Sachverhalt in ein minimales \redalert{Datenmodell} einer Sprache Ihrer Wahl\footnote{Für diese Aufgabe ist es i.O., wenn Sie sich auf die wesentlichen Aspekte konzentrieren und diese im Datenmodell darstellen.}: \bigskip
...
\begin{frame}{Datenstrukturelement: Seite}
	...
	Mit Ausnahme von Datentypen und Subobjects werden alle Datenmodellelemente im Rahmen einer Seite definiert.
