...
\begin{enumerate}
	\item Is an application that we use when we browse the WWW.
	...
	\item It understands URL and knows how to translates URL into web resources, e.g., HTML text files, images, videos, etc.
