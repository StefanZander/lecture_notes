...
const myPromise = new Promise( (resolve, reject) => {
    ...
    if (rand === 0) { // success
        resolve({ "name": "Bello", "type": "Hund"} ); // changed to demonstrate passing objects
    } else { // failure
...
myPromise
    .then((data) => { console.log(`Success – ${data.name} ist ein ${data.type};`); } )
...
let filter = "m"; // displays all cities beginning with 'm'
