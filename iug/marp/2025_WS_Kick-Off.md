...
<!-- marp --engine ./engine.js --watch --theme-set custom-theme-roboto.css -- --allow-local-files 2025_WS_Kick-Off.md -->
<!-- marp --pdf --allow-local-files --engine ./engine.js --theme-set custom-theme-roboto.css -- 2025_WS_Kick-Off.md -->
...
<!-- footer: von Römer & Zander | Informatik und Gesellschaft | Wintersemester 2025/2026 | Kick-Off – 07.10.2025  -->
...
---
# Interessante Quellen zur Sensibilisierung
...
![width:200px](https://img.youtube.com/vi/3VEkzweBJPM/0.jpg)
::::
:::::
...
<!--
---
:fa-comments: Einsteigsfrage{.center}

:::huge center vert-center huge
...
- :fa-circle-question: Was macht eine Gesellschaft lebenswert?
- :fa-circle-question: Wie mitgestalten? Wo Verantwortung übernehmen?
- :fa-circle-question: Welche Rolle spielt die Informatik dabei?
...
::::
:::: single
![](figures/boy_girl_greece_temple.jpg)
::::
::::: -->
...
- Im Vorfeld: Beschäftigung mit dem jew. Wochenthema 
- Gruppenvortrag und Diskussionsleitung (1x)
- Quiz-Durchführung und Moderation (1x)
...
---
# Anforderungen an Sie :fa-person-digging:

**Vorbereitung und Leitung einer Seminarstunde**
- Ausführliche und selbständige Recherche zu ihrem Thema 
- Gruppenpräsentation, Interaktion und Diskussionsleitung zu einem Thema (max. 45 Min.)
...
- :fa-triangle-exclamation: Ein zweites unentschuldigtes Fehlen führt zum Nichtbestehen des Moduls
...
- :fa-book-open: Lesen der bereitgestellten Literatur
- :fa-magnifying-glass: Selbständige Suche nach weiteren, wissenschaftlich-belastbaren und seriösen Quellen
- :fa-microscope: Entwicklung zentraler Aussagen oder Thesen, welche im Vortrag argumentativ gestützt und verteidigt werden
- :fa-people-arrows: Interaktionsmodelle konzipieren und integrieren
- :fa-users-viewfinder: Lernziele definieren und diese in Quizfragen überführen
- :fa-comments: Selbständiges Einholen von Feedback der Dozierenden
...
<!-- ![bg right:25% width:800](figures/men_lifting_stone.jpg) -->
...
- **Sie stellen ihr Thema anregend vor und leiten hin zu einer Diskussion**
  - Mit _Gesellschaftsbezug_!
  - Keine technischen Details oder Sachvorträge, aber korrekte Definition und Einordnung ihres Themas
  - Entwickeln Sie _Thesen_ die :fas-person-circle-exclamation: aufrütteln, :fas-heart-circle-exclamation: provozieren, :fas-comments: zum Diskutieren einladen

- **Sie kennen ihr Thema – ihre Kommilitonen lernen etwas Neues**
   - ==Keine „Zusammenfassung“ der vorgegebenen Quellen==; Quellen sind *Startpunkt* für :fa-magnifying-glass: *eigene Recherchen*
   - Entwickeln sie _eigene Fragestellungen_ und _Hypothesen_
   - Sie sind relativ frei in der Gestaltung ihres Themas

- **Formalien**
  - wissenschaftliche Quellenangaben (bei Bildern, Zitaten, Studien, Methoden etc. direkt auf der Folie), Seitenzahlen, …
...
- Auslegung des Quizzes auf etwa *7 - 8 Minuten (max.)* 
- Fragen zeitlich begrenzen; gerne mit unterschiedlichen Fragetypen^1^
- Moderation des Quizzes und der Ergebnisse und Rangliste am Beamer
...
**Erwartung**: Fundierte Quellenarbeit (vorgegebene + eigene); schlüssige, nachvollziehbare Argumentation und Ausarbeitung; souveräne Moderation und professionelle Präsentation
:::

:fa-dice: **Quiz** {.bluebox .big}

::: bluebox
Auf- bzw. Abwertung der Hauptnote entspr. der Ausarbeitung und Moderation
**Leistung**: Vorbereitung und Durchführung eines Quizzes zu den wesentlichen Inhalten & Lernzielen  
**Erwartung**: Angemessene Komplexität und Umfang; Schlüssigkeit und Nachvollziehbarkeit der Fragen; 
:::

:fa-ranking-star: **Rangliste** {.bluebox .big}

::: bluebox
Möglichkeit zur Verbesserung der Hauptnote um bis zu einer Teil-Notenstufe; bei Nichtteilnahme Abzug 
...
::: greenbox
Optional; Verbesserung der Note um eine Teil-Notenstufe (+/- 0,3) durch individuelle Mitarbeit
...
![bg right:33%](figures/senate_small.jpg)

- :fa-people-roof: Gruppen-/Teamarbeit sichtbar in "rundem" Aufbau, Inhalt, Template, etc.

- :fa-book: Thema getroffen, gut strukturiert, sinnvoller Aufbau, roter Faden erkennbar, nachvollziehbare Überleitungen

- :fa-microphone: Lautstärke, Tempo, Modulation, freies Sprechen, Mimik, Gestik, Körperhaltung, Blickkontakt

- :fa-users-line: Interesse wecken, „Botschaft erkennbar“, anregende Thesen für Diskussion hergeleitet, nachvollziehbare Kausalitätsketten; logisch und fundierte Inhalte
...
<!-- 
11. Postdemokratie und Technokratie – Wird Politik von Konzernen und Experten übernommen?
11. ~~ChatGPT in Studium und Lehre - Nur ein neues Werkzeug oder mehr?~~
12. ~~Sind Systeme wie TikTok eine Gefahr für uns als Gesellschaft und unsere demokratischen Grundprinzipien?~~
-->
