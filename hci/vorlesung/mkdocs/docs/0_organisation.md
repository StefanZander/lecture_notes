...
## Allgemeines 
Auf dieser Seite sowie in nachstehend verlinktem Foliensatz finden sie alles Wissenswerte zur Lehrveranstaltung:
<!--
...
!!! warning "Didaktisches Modell der Veranstaltung"
    Bitte machen sie sich vor Semesterbeginn mit dem :material-school: [didaktischen Modell](didaktik.md) der Veranstaltung vertraut um abschätzen zu können, ob dieses ihren eigenen Lehr- und Lernpräferenzen entspricht. Die Veranstaltung legt einen hohen Wert auf Eigenverantwortung, Selbst- und Gruppenorganisation sowie Leistungs- und Gestaltungsbereitschaft. Sie bietet gleichzeitig aber auch ein hohes Maß an Gestaltungsfreiraum, Selbstverwirklichung und selbst-organisiertem Studieren in Gruppen.  
...
2. Das individuelle [Fachgespräch](fachgespraech.md)
3. Die Beitragsmatrix

Genauere Details zu den einzelnen Bewertungsaspekten finden sich im [Foliensatz zur Organisation der Veranstaltung](https://code.fbi.h-da.de/zander/hci/material/-/raw/main/0_organisation/01_organisation.pdf) (_abrufbar nach Anmeldung über code.fbi.h-da.de_) 

### Punkte-/Notenschema für das Semesterprojekt
...
Punkte (neu)	
10	1							40 - 38		1				40 		- 38
9	1,5							37 - 36 	1,3				37,5 	- 35
8	2							35 - 34 	1,7				34,5	- 32,5
7	2,5							33 - 32		2,0				32 		- 30
6	3							31 - 30		2,3				29,5 	- 27
5	3,5							29 - 28		2,7				26,5 	- 24,5 
4	4							27 - 26		3				24 		- 22
3	4,5							25 - 24		3,3				21,5 	- 19
2	5							23 - 22		3,7				18,5 	- 16,5
1	5							21 - 20		4,0				16 		- 14 
0	Ausschluss					
-->
