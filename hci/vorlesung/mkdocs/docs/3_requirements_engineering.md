...
1. :material-file-pdf-box: [Einführung: Über die Wichtigkeit und Notwendigkeit eines Ingenieurs-mäßigen Umgangs mit Anforderungen](https://code.fbi.h-da.de/zander/hci/material/-/raw/main/3_requirements_engineering/01_intro.pdf?ref_type=heads&inline=true)
...
1. :material-file-pdf-box: [Begriffsdefinitionen](https://code.fbi.h-da.de/zander/hci/material/-/raw/main/3_requirements_engineering/02_definitions.pdf?ref_type=heads&inline=true)
2. :material-file-pdf-box: [Stakeholder](https://code.fbi.h-da.de/zander/hci/material/-/raw/main/3_requirements_engineering/05_stakeholder.pdf?ref_type=heads&inline=true)
...
1. :material-file-pdf-box: [Anforderungsarten](https://code.fbi.h-da.de/zander/hci/material/-/raw/main/3_requirements_engineering/03_req_types.pdf?ref_type=heads&inline=true)
...
1. :material-file-pdf-box: [Verifikation von Qualitätsanforderungen](https://code.fbi.h-da.de/zander/hci/material/-/raw/main/3_requirements_engineering/04_verification.pdf?ref_type=heads&inline=true)
...
1. :material-file-pdf-box: [Die Systemkontextanalyse](https://code.fbi.h-da.de/zander/hci/material/-/raw/main/3_requirements_engineering/06_context.pdf?ref_type=heads&inline=true)
...
1. :material-file-pdf-box: [Das KANO-Modell](https://code.fbi.h-da.de/zander/hci/material/-/raw/main/3_requirements_engineering/07_kano.pdf?ref_type=heads&inline=true)
...
1. :material-file-pdf-box: [Anforderungsermittlung und -dokumentation](https://code.fbi.h-da.de/zander/hci/material/-/raw/main/3_requirements_engineering/08_documentation.pdf?ref_type=heads&inline=true)
2. :material-file-pdf-box: [Transformationseffekte](https://code.fbi.h-da.de/zander/hci/material/-/raw/main/3_requirements_engineering/09_transformationeffects.pdf?ref_type=heads&inline=true)
3. :material-file-pdf-box: [Die Satzschablone](https://code.fbi.h-da.de/zander/hci/material/-/raw/main/3_requirements_engineering/10_satzschablone.pdf?ref_type=heads&inline=true)
