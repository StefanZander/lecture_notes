...
!!! success "Ergebnisse"
    - [x] Vorbereitung und Konfiguration einer IDE Ihrer Wahl für die Entwicklung von Flutter-Apps
    - [x] Lauffähige Flutter-App aus dem Flutter-Codelab 
    - [x] Grundverständnis was Widgets sind und welche Rolle diese in der Flutter-Etnwicklung spielen
    - [x] Kennenlernen von zustandslosen und zustandsbehafteten Widgets
    - [x] Kennenlernen eines Ansatzes zur Speicherung von globalen Zustandsinformationen
...
Nach Abschluss von [Meilenstein #4](ms4.md) sollten Sie das folgende Ergebnis erarbeitet haben:

!!! success "Ergebnis"
    - [x] Einen erste ausführbare Version ihrer App, welche die erforschten und erarbeiteten Ergebnisse aus [Meilenstein #2](ms2.md) und [#3](ms3.md) in sinnvoller, d.h., nutzendenzentrierter Art verkörpert unter Berücksichtigung der umzusetzenden [technischen Merkmale](https://zander-hci-flutter.netlify.app/#diese-elemente-sollten-in-die-app).
