...
% SZA: Added float package to places figures at exact positions in texts (see: https://tex.stackexchange.com/questions/8625/force-figure-placement-in-text)
% Note: [H] at figures does not work!!!
\usepackage{float} 
