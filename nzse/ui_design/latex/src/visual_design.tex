...
\subsection{Fact Hunting or How to create good Content Usability}\marginnote[-1em]{or:\par \emph{``How to create a good Content Usability''}} % (fold)
\label{sub:fact_hunting}


% subsection fact_hunting (end)
Always keep bear in mind that users hunt for facts online, so \textbf{factually rich content} will attract readers and keep their attention\sidenote{Source: \url{https://www.nngroup.com/articles/write-interesting-facts/}}.
...
\begin{figure}%
	\centering
  \includegraphics[width=1.55\textwidth]{../figures/content_usability_bamf.png}
  \caption[][57em]{Content usability of an rticle about the ``Digitalisierungsagenda 2020'' published by the German Federal Office for Migration and Refugees (BAMF). (Accessed September 27th, 2019.) }
