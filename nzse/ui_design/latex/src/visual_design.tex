...
This statement might be true for power or expert users, but it fails the ordinary people.
...
Good visual design is important for a good user experience:
\begin{itemize}[]
	...
	\item The text needs to be readable [dt.~\emph{lesenswert}] (--> typography) and legible [dt.~\emph{leserlich}] have a clear visual hierarchy
