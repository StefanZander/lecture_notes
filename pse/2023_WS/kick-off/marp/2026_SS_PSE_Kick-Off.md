...
<!-- marp --engine ./engine.js --watch --theme-set custom-theme-roboto.css -- --allow-local-files 2026_SS_PSE_Kick-Off.md -->
<!-- marp --pdf --allow-local-files --engine ./engine.js --theme-set custom-theme-roboto.css -- 2026_SS_PSE_Kick-Off.md -->

# Projekt-Systementwicklung im SoSe 2026

#### Prof. Dr. Stefan Linus Zander

Kick-Off-Meeting – 21.04.2026  {.lightgreen .Big .skip}


---
<!-- header: Überblick -->
<!-- footer: Projekt Systementwicklung / Projekt Multimedia – Kick-Off-Meeting, 21.04.2026 -->
...
<!--
---
# Durchführung – TODO: raus bzw. Aufgaben anderswo einbauen
...
- 30 CP entspricht 900 Arbeitsstunden pro Semester
- Daraus folgt: 900 h / (30 CP / 7,5 CP) / 18 Wochen^1^ = **12,5 h wöchentliche Arbeitszeit** bei einer 50h Woche

Jetzt realistisch:
- Bei einer wöchentlichen Arbeitszeit von **42 h** ergibt sich ein zeitlicher Aufwand von **10,5 h** (ohne Pausen) über **16 Wochen** hinweg
- Dass ist das zeitliche Engagement, das wir von Ihnen einfordern!
- Aber: Den zeitlichen Aufwand dürfen Sie _frei einteilen_
<!-- - Zeitlicher Aufwand von **10,5h** wöchentliche Arbeitszeit (ohne Pausen) über **16 Wochen** hinweg^1^ -->

::: redbox center marg20 Bigskip
In Summe veranschlagen wir pro Person ein :far-clock: **Gesamtzeitbudget** von **160h - 170h**
:::

::: footnotes
^1^ Vorlesungszeit (14 Wochen) + Lernwoche (1 Woche) + Prüfungszeit (3 Woche)
:::
...
**GitLab** :fab-gitlab:
- Für das Projekt existiert ein internes **GitLab-Repository**: <https://code.fbi.h-da.de/pse_zander/hci_ki_projektmappenchecker>
...
- Link: <https://taiga.fgmmgr.users.h-da.cloud/project/hci_ki_projektmappenchecker/>
...
---
# :fas-user-check: Das erwarte ich von Ihnen

- Vollständig und sauber ausgearbeitete Projektdokumentation mit allen wesentlichen Resultaten und Entwurfsentscheidungen
- Selbständiges eigenverantwortliches Projektmanagement 
- Engagement, Eigeninitiative und proaktive Projektmitarbeit
- Anwendung wissenschaftlicher Arbeitsmethodiken (Analysen, Recherchen etc.)
- Umfassender User Research
- Sauber dokumentierte Anforderungsanalyse inkl. Kriterienkatalog
- Experimentelle Erforschung (Analyse + Erprobung + Bewertung + Dokumentation) der verschiedenen Umsetzungsmöglichkeiten 
- Evaluierung des gewählten Ansatzes mit echten Nutzenden

::: redbox center marg20 Bigskip
:fas-circle-exclamation: Das alles ordentlich, nachvollziehbar und umfassend dokumentiert.
:::
...
- **Students** :fas-graduation-cap:  
  - You assume the role of the :fas-industry: **contracted company** and are expected to **plan** and **execute** the project independently and responsibly. Specifically, this includes:
    - Define the **roles and responsibilities** within your project team 
    - Establish your **organizational structure**, i.e., determine how you will collaborate and organize your internal workflows
    - Assign **work package (WP) leads** and specify detailed content  
    - Conduct **team meetings** autonomously and document them  
    - Communicate effectively with **stakeholders** and the **client**.  
    - Coordinate necessary **planning** and **decision-making processes** both within the team and with the client  
    - **Monitor project progress** and review the outcomes  
...
:fas-hand-point-right: Good Epic names describe what outcome is achieved, not how it is implemented.
