...
:::: columns
::: single
- **WP : Bezahl- und Abrechungsfunktion (RT)** <!-- _(3-4 Personen)_ -->
  - 
...
- **WP : Website & App-Stores (SZ/RT)** <!-- _(2-3 Personen)_ -->
  - 

- **WP : Usability-Verbesserungen + Bugfixing (SZ/LK)**  <!--_(3-4 Personen)_ -->
  - 
:::
::::
